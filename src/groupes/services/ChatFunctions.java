 ...
 Utilisateur current;
     public void setUtilisateur(Utilisateur current){
        this.current=current;
         idO=this.current.getId();
         idOwner = (int)idO;
         System.out.println("GroupFunctions" + current);
    }
    ...
    public void Send(long idOwner,Text EmailTXT, String text) throws SQLException{
      LocalDateTime currentDateTime = LocalDateTime.now();
        String insertSql = "INSERT INTO Conversation (idUser1, idUser2, Date_MSG, Msg,isRead) VALUES (?, ?, ?, ?,?)";
    ...
    preparedStatement.setString(1, newEmail);
     ...
     preparedStatement.close();
        System.out.println("DONE? :::   " + rowsUpdated);
    }
    public void loadConversation(int idOwner,ListView<String> conversationListView,ListView<String> conversationListView1) throws SQLException, Exception {
...
conversationListView1.getItems().clear();
        ...
        while (resultSet.next()) {
            ...
            try {
              formattedMessage = formatMessage(timestamp, MF.decrypt(message,5));
   ...
   java.sql.ResultSet resultSet2 = preparedStatement.executeQuery();
    while (resultSet2.next()) {
            ...
            String formattedMessage = formatMessage(timestamp,MF.decrypt(message,5));
